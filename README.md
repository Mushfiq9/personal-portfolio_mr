...
<head>
  ...
  <meta name="description" content="Mushfiqur Rahman — Professional WordPress & WooCommerce Developer." />
  <title>Mushfiqur Rahman • WordPress Developer</title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;800&display=swap" rel="stylesheet">
  <style>
    :root{
      --bg:#0b1020; --muted:#93a4c3; --text:#e7edff;
      --brand:#4facfe; --brand-2:#00f2fe; --accent:#ffb347; --highlight:#ff61a6; --deep:#6a11cb;
    }
    *{box-sizing:border-box;margin:0;padding:0}
    body{font-family:Inter,sans-serif;color:var(--text);background:var(--bg);overflow-x:hidden;position:relative;min-height:100vh;}

    /* Heavy 3D animated background */
    body::before{
      content:"";position:fixed;inset:0;z-index:-2;
      background:radial-gradient(circle at 20% 30%,rgba(79,172,254,.35),transparent 60%),
                 radial-gradient(circle at 80% 70%,rgba(255,97,166,.25),transparent 60%),
                 radial-gradient(circle at 50% 90%,rgba(106,17,203,.3),transparent 60%);
    ...
    .cube{
      ...
      transform-style:preserve-3d;animation:spinCube 30s linear infinite;
    }
    .face{
      position:absolute;width:300px;height:300px;background:linear-gradient(135deg,var(--brand),var(--deep));opacity:0.08;border:2px solid rgba(255,255,255,0.05);
    }
